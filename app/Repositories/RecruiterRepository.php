...
class RecruiterRepository extends BaseRepository implements RecruiterContract
{

    /**
     * RecruiterRepository constructor.
     * @param Recruiter $model
     */
    public function __construct(Recruiter $model)
    {
    ...
    {
        return $this->selectAsTextValuePair('label', 'id');
    }
    ...
    public function createItem(array $params)
    {
        try {
            ...
            $item = new Recruiter($collection->all());
            $item->save();
