...
class IntakeRepository extends BaseRepository implements IntakeContract
{

    /**
     * IntakeRepository constructor.
     * @param Intake $model
     */
    public function __construct(Intake $model)
    {
    ...
    public function createItem(array $params)
    {
        try {
            ...
            $item = new Intake($collection->all());
            $item->save();
